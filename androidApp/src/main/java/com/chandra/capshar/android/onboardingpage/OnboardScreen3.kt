...
fun OnboardScreen3(){
    ...
    val title = "Share your expertise and knowledge with the world. Upload valuable resources, articles, or guides, and let others benefit from your wisdom."
        ...
        Column (modifier = Modifier.padding(top= 50.dp)){
            ...
            BoxWithConstraints(modifier = Modifier
                ...
                Row(
                    ...
                    Text(textAlign = TextAlign.Center, text = "Create Your Resource Post", fontFamily = fontFamLex, fontSize = 30.sp)
                }
            }
